    ...
    <>
      ...
      <ScrollContainer>
        ...
        <p>
          ...
          Brazil) and processed to generate spreadsheets with the location of
          the fires. An algorithm identifies if these locations are inside or
          outside the Amazon biome perimeter, and these are then shown as a
          counter, constantly being refreshed as satellite information is made
          available. If one location is repeatedly reported as a hotspot, the
          algorithm disregards it and doesn’t add it to the current count.
        </p>
        <p>
          There are many other satellites covering the same area aside from the
          GOES-16. They differ in resolution, pixel size (some of them may
          capture fires as small as 1m x 30m, while the GOES-16’s pixels are 2km
          x 2km), and orbit.
        </p>
        <p>
          ...
          is displayed in the{' '}
          <Link onClick={handleClick}>WHY SO MANY FIRES</Link> section.
        </p>
        <p>
          ...
          precise data of what exactly is burning and how much has already
          burnt.
        </p>
      </ScrollContainer>
    </>
